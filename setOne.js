...
// CODE HERE
twoParams = (param1, param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}.`)
...
Then, outside of the greeting function, invoke the greeting function, passing in the value firstName and lastName of your choice, and a callback function that takes a parameter of fullName. The callback
 function will print 'Hello, my full name is [fullName]'. 
*/

// CODE 'GREETING FUNCTION' HERE
fullName = (fullName) => console.log(`Hello, my full name is ${fullName}`)
...
// CODE HERE
pricesPlusTax(prices, tax = (totalCost) => { console.log(`The new array plus tax = ${totalCost}`)})
